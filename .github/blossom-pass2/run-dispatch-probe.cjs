...
async function runDispatchProbe({github, context, core, fixtureName, prNumber, expectedPrHeadSha}) {
  ...
  try {
    return await withWebhookFixture(fixtureName, async fixture => {
      ...
      const verdict = assessDispatch(fixture, {...execution, auditText, auditRecords, newReactions, newStatuses, runUrl});
